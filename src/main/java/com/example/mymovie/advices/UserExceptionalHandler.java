...
public class UserExceptionalHandler {
    ...
    public ResponseEntity<Object> handleCustomernotFoundException(UserNotFoundException userNotFoundException){
...
// @ResponseStatus(HttpStatus.CONFLICT)
// @ExceptionHandler(value = {UserAlreadyExistsException.class})
//    public ResponseEntity<Object> handleMovieAlreadyExistsException(UserAlreadyExistsException userAlreadyExistsException) {
//       
//        Map<String, String> errorMap= new HashMap<>();
//
